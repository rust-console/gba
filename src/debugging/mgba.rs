...
const ENABLE_ADDRESS: VolAddress<u16, Safe, Safe> =
  unsafe { VolAddress::new(0x4fff780) };
const ENABLE_ADDRESS_INPUT: u16 = 0xC0DE;
const ENABLE_ADDRESS_OUTPUT: u16 = 0x1DEA;

const OUTPUT_BLOCK: VolBlock<u8, Safe, Safe, 256> =
  unsafe { VolBlock::new(0x4fff600) };

const SEND_ADDRESS: VolAddress<u16, Safe, Safe> =
  unsafe { VolAddress::new(0x4fff700) };
...
impl DebugInterface for MGBADebugInterface {
  ...
  fn debug_print(
    &self, debug: DebugLevel, args: &Arguments<'_>,
