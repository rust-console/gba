...
pub trait Gen32 {
  ...
  /// [`BoundedRandU32`](crate::random::BoundedRandU32) if you don't need to use
  /// a specific bound value more than once.
  ///
  /// ## Panics
  /// * If the input is 0.
  #[inline]
    ...
    Self: Sized,
  {
    ...
    let mut possibility_count: u16 =
      buf.len().try_into().unwrap_or(u16::max_value());
